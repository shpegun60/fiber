...
FIBER_STATIC_ASSERT(FIBER_PORT_CM33_MPU_CONTEXT_REGION_COUNT == 4u,
		"[fiber]: ARM_CM33_MPU 8-region context image changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, protected_context_cursor) == 0u,
		"[fiber]: ARM_CM33_MPU 8-region cursor offset changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, mair0) == 4u,
		"[fiber]: ARM_CM33_MPU 8-region MAIR0 offset changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, mpu_regions) == 8u,
		"[fiber]: ARM_CM33_MPU 8-region MPU image offset changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, protected_context) == 40u,
		"[fiber]: ARM_CM33_MPU 8-region protected context offset changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, runtime_flags) == 124u,
		"[fiber]: ARM_CM33_MPU 8-region flags offset changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, boot) == 128u,
		"[fiber]: ARM_CM33_MPU 8-region boot offset changed");
FIBER_STATIC_ASSERT(sizeof(FiberContext) == 216u,
		"[fiber]: ARM_CM33_MPU 8-region context size changed");
#else
FIBER_STATIC_ASSERT(FIBER_PORT_CM33_MPU_CONTEXT_REGION_COUNT == 12u,
		"[fiber]: ARM_CM33_MPU 16-region context image changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, protected_context_cursor) == 0u,
		"[fiber]: ARM_CM33_MPU 16-region cursor offset changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, mair0) == 4u,
		"[fiber]: ARM_CM33_MPU 16-region MAIR0 offset changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, mpu_regions) == 8u,
		"[fiber]: ARM_CM33_MPU 16-region MPU image offset changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, protected_context) == 104u,
		"[fiber]: ARM_CM33_MPU 16-region protected context offset changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, runtime_flags) == 188u,
		"[fiber]: ARM_CM33_MPU 16-region flags offset changed");
FIBER_STATIC_ASSERT(offsetof(FiberContext, boot) == 192u,
		"[fiber]: ARM_CM33_MPU 16-region boot offset changed");
FIBER_STATIC_ASSERT(sizeof(FiberContext) == 280u,
		"[fiber]: ARM_CM33_MPU 16-region context size changed");
#endif

FIBER_STATIC_ASSERT(alignof(FiberContext) == 8u,
		"[fiber]: ARM_CM33_MPU context alignment changed");

int fiber_arm_cm33_mpu_layout_probe(void)
{
