 ...
 * ARM_CM55_NTZ/non_secure non-MPU scalar-FP PendSV backbone.
 *
...
uint32_t *fiber_test_freertos_cm55f_current;

void fiber_test_freertos_cm55f_switch(void);

FIBER_TEST_REFERENCE_ATTR
void fiber_test_freertos_cm55f_pendsv(void)
{
	__asm volatile(
			".syntax unified                         \n"
			"mrs   r0, psp                          \n"
			...
			"mov   r3, lr                           \n"
			"stmdb r0!, {r2-r11}                    \n"
			"ldr   r2, =fiber_test_freertos_cm55f_current \n"
			"ldr   r1, [r2]                         \n"
			"str   r0, [r1]                         \n"
			"movs  r0, #0                           \n"
			"msr   basepri, r0                      \n"
			"dsb                                    \n"
			"isb                                    \n"
			"bl    fiber_test_freertos_cm55f_switch \n"
			"movs  r0, #0                           \n"
			"msr   basepri, r0                      \n"
			"ldr   r2, =fiber_test_freertos_cm55f_current \n"
			"ldr   r1, [r2]                         \n"
