...
| Cortex-M55 feature cohorts / STM32N6 | Scalar, scalar-FP, MVE-FP, and no-feature MPU are complete explicit build-selected software cohorts. `transitional_v8m` remains only for unported v8-M roles. | Complete M55 MPU FPU/MVE protected variants, TrustZone/SecureContext or TF-M, and PAC/BTI cohorts, then validate matching hardware. |
