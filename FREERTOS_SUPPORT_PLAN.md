...
| Cortex-M4F/M7F MPU | Non-selectable `port/ARM_CM4_MPU` slice 1 freezes the pinned FreeRTOS 53-word protected FP context, explicit 8/16-region MPU layouts, exact traits/cohorts, and parity ledger; no runtime source or handler exists | Implement construction, protected SVC/PendSV, exact linker isolation, full ABI integration, then separate M4F/M7F hardware claims |
