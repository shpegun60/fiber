...
| Cortex-M4F/M7F MPU | Non-selectable `port/ARM_CM4_MPU` slices 1-2 freeze the pinned FreeRTOS 53-word protected FP context and implement exact 8/16-region stack/default MPU-image construction, linker isolation, sealing, and M4F/M7F compile/link proofs; no handler or switch runtime exists | Implement protected SVC/PendSV, MPU/FPU startup and readback, full ABI integration, then separate M4F/M7F hardware claims |
