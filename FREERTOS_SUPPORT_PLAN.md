...
| Cortex-M55 feature cohorts / STM32N6 | The scalar NTZ profile is intentionally incomplete for a full STM32N6 image; `transitional_v8m` remains only for unported v8-M roles. | Add distinct M55F, MVE-FP, MPU, TrustZone/SecureContext or TF-M, and PAC/BTI cohorts, then validate matching hardware. |
