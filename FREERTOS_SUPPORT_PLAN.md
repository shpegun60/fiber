...
It records eleven runtime-capable concrete profiles, including the explicitly
build-selected `ARM_CM0_MPU` and `ARM_CM33_MPU/non_secure` protected runtimes
with their archive/linker proofs, then the remaining CM33 security/FP-MPU,
CM55/N6, and announced CM85/V8 work, planning ranges, and the exact gate before
Context extraction.
