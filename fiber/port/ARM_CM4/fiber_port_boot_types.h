/* ARMv7E-M-owned immutable boot metadata. */
#ifndef FIBER_PORT_ARM_CM4_FIBER_PORT_BOOT_TYPES_H_
#define FIBER_PORT_ARM_CM4_FIBER_PORT_BOOT_TYPES_H_
...
#endif /* FIBER_PORT_ARM_CM4_FIBER_PORT_BOOT_TYPES_H_ */
