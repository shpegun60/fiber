/* ARM_CM4 declarations shared only by the selected port implementation. */
#ifndef FIBER_PORT_ARM_CM4_FIBER_PORT_PRIVATE_H_
#define FIBER_PORT_ARM_CM4_FIBER_PORT_PRIVATE_H_
...
#endif /* FIBER_PORT_ARM_CM4_FIBER_PORT_PRIVATE_H_ */
