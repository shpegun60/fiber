/* ARM_CM55_MPU/non_secure protected construction and linker contract. */
#ifndef FIBER_PORT_ARM_CM55_MPU_NON_SECURE_FIBER_PORT_BOOT_H_
#define FIBER_PORT_ARM_CM55_MPU_NON_SECURE_FIBER_PORT_BOOT_H_
...
FIBER_STATIC_ASSERT(sizeof(FiberPortMpuMemoryLayout) == (12u * 4u),
		"[fiber]: ARM_CM55_MPU linker-layout ABI changed");
FIBER_STATIC_ASSERT(sizeof(FiberPortMpuGlobalRegionImage) == (4u * 8u),
		"[fiber]: ARM_CM55_MPU global MPU-image ABI changed");
...
#endif /* FIBER_PORT_ARM_CM55_MPU_NON_SECURE_FIBER_PORT_BOOT_H_ */
