/*
 * ARM_CM55F_MPU/non_secure protected scalar-FP PendSV component.
 *
 * This source owns the later runtime form of the frozen 54-word protected
 * context image. It follows the MPU plus FPU branch of FreeRTOS
		...
		uint32_t exc_return)
{
	...
	/* Unlike the ordinary PSP-resident scalar-FP port, FreeRTOS MPU PendSV
