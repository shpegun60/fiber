/*
 * Public storage for the build-selected ARM_CM55F_MPU/non_secure profile.
 *
 * The protected image mirrors FreeRTOS ARM_CM55_NTZ with MPU plus scalar FPU.
 ...
 */
#ifndef FIBER_PORT_ARM_CM55F_MPU_NON_SECURE_FIBER_PORT_TYPES_H_
#define FIBER_PORT_ARM_CM55F_MPU_NON_SECURE_FIBER_PORT_TYPES_H_
...
# error "[fiber]: ARM_CM55F_MPU requires an explicit 8- or 16-region MPU manifest"
#endif
...
#define FIBER_PORT_CM55F_MPU_CONTEXT_REGION_COUNT \
	(FIBER_PORT_CM55F_MPU_TOTAL_REGIONS - 4)
...
# error "[fiber]: ARM_CM55F_MPU type layout currently supports GCC-compatible compilers only"
#endif
...
struct __attribute__((aligned(8))) FiberContext {
	...
	uint32_t mair0;
	FiberPortMpuRegionRegisters
		mpu_regions[FIBER_PORT_CM55F_MPU_CONTEXT_REGION_COUNT];
...
#endif /* FIBER_PORT_ARM_CM55F_MPU_NON_SECURE_FIBER_PORT_TYPES_H_ */
