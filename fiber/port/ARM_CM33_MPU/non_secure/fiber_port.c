/*
 * ARM_CM33_MPU/non_secure protected selected runtime.
 *
 ...
 * GCC/ARM_CM33_NTZ/non_secure MPU ordering: first start installs global MPU
...
#define FIBER_CM33_MPU_UNPRIVILEGED \
	FIBER_API_ATTR_SENSITIVE FIBER_GENERAL_REGS_ONLY \
...
/*
 * Protected ARMv8-M Mainline MPU context switch.
 *
 * This mirrors the pinned FreeRTOS ARM_CM33_NTZ MPU sequence: the complete
...
#undef FIBER_CM33_MPU_UNPRIVILEGED
