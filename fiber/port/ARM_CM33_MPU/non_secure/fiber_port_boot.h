/* ARM_CM33_MPU/non_secure protected construction and linker contract. */
#ifndef FIBER_PORT_ARM_CM33_MPU_NON_SECURE_FIBER_PORT_BOOT_H_
#define FIBER_PORT_ARM_CM33_MPU_NON_SECURE_FIBER_PORT_BOOT_H_
...
FIBER_STATIC_ASSERT(sizeof(FiberPortMpuMemoryLayout) == (12u * 4u),
		"[fiber]: ARM_CM33_MPU linker-layout ABI changed");
FIBER_STATIC_ASSERT(sizeof(FiberPortMpuGlobalRegionImage) == (4u * 8u),
		"[fiber]: ARM_CM33_MPU global MPU-image ABI changed");
 ...
 * maps exactly to one ARMv8-M RBAR/RLAR pair. `region_number` is validated but
 ...
 * must be one exact 32-byte-granular ARMv8-M MPU region inside linker-owned
...
#endif /* FIBER_PORT_ARM_CM33_MPU_NON_SECURE_FIBER_PORT_BOOT_H_ */
