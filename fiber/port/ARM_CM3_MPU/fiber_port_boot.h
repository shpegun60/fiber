/* ARMv7-M MPU-owned context construction and memory-layout contract. */
#ifndef FIBER_PORT_ARM_CM3_MPU_FIBER_PORT_BOOT_H_
#define FIBER_PORT_ARM_CM3_MPU_FIBER_PORT_BOOT_H_
...
/* These are linker symbols. Their addresses are the range boundaries. */
...
/* Returning from an unprivileged entry is a port-owned SVC service. It must
 * never branch directly into privileged common text. */
...
#endif /* FIBER_PORT_ARM_CM3_MPU_FIBER_PORT_BOOT_H_ */
