/* ARM_CM7 r0p1 declarations shared only by the selected port implementation. */
#ifndef FIBER_PORT_ARM_CM7_R0P1_FIBER_PORT_PRIVATE_H_
#define FIBER_PORT_ARM_CM7_R0P1_FIBER_PORT_PRIVATE_H_
...
#endif /* FIBER_PORT_ARM_CM7_R0P1_FIBER_PORT_PRIVATE_H_ */
