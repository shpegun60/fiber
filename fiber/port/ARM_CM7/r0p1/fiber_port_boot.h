 ...
 * fiber_port_boot.h
 *
 * ARM_CM7/r0p1 boot-record and first-start ABI. The matching port source owns
 * all record construction, integrity, stack geometry, and CPU startup policy.
 */

#ifndef FIBER_PORT_ARM_CM7_R0P1_FIBER_PORT_BOOT_H_
#define FIBER_PORT_ARM_CM7_R0P1_FIBER_PORT_BOOT_H_
...
#endif /* FIBER_PORT_ARM_CM7_R0P1_FIBER_PORT_BOOT_H_ */
