 ...
 * fiber_port.c
 *
 * ARM_CM55F_NTZ Non-secure scalar-FP PendSV runtime.
 *
 ...
 * frame only when EXC_RETURN describes an extended FP hardware frame.
 */
...
FIBER_STATIC_ASSERT(fiber_portOFF_STACK_BASE < 4096u,
		"[fiber]: ARM_CM55F_NTZ stack-base offset must fit Thumb-2 LDR");
FIBER_STATIC_ASSERT(fiber_portOFF_STACK_TOP < 4096u,
		"[fiber]: ARM_CM55F_NTZ stack-top offset must fit Thumb-2 LDR");
FIBER_STATIC_ASSERT((fiber_portOFF_STACK_BASE & 3u) == 0u,
		"[fiber]: ARM_CM55F_NTZ stack-base offset must be word aligned");
FIBER_STATIC_ASSERT((fiber_portOFF_STACK_TOP & 3u) == 0u,
		"[fiber]: ARM_CM55F_NTZ stack-top offset must be word aligned");
FIBER_STATIC_ASSERT(fiber_portOFFSET_EXTENDED_STACKED_XPSR == 100u,
		"[fiber]: ARM_CM55F_NTZ extended xPSR offset changed");
