/* ARM_CM33_TFM declarations shared only by its implementation objects. */
#ifndef FIBER_PORT_ARM_CM33_TFM_FIBER_PORT_PRIVATE_H_
#define FIBER_PORT_ARM_CM33_TFM_FIBER_PORT_PRIVATE_H_
...
#endif /* FIBER_PORT_ARM_CM33_TFM_FIBER_PORT_PRIVATE_H_ */
