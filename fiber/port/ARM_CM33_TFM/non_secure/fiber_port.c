/* ARM_CM33_TFM exact non-MPU context construction and runtime. */
...
FIBER_STATIC_ASSERT(fiber_portOFF_STACK_BASE < 4096u,
		"[fiber]: ARM_CM33_TFM stack-base offset must fit Thumb-2 LDR");
FIBER_STATIC_ASSERT(fiber_portOFF_STACK_TOP < 4096u,
		"[fiber]: ARM_CM33_TFM stack-top offset must fit Thumb-2 LDR");
FIBER_STATIC_ASSERT((fiber_portOFF_STACK_BASE & 3u) == 0u,
		"[fiber]: ARM_CM33_TFM stack-base offset must be word aligned");
FIBER_STATIC_ASSERT((fiber_portOFF_STACK_TOP & 3u) == 0u,
		"[fiber]: ARM_CM33_TFM stack-top offset must be word aligned");
...
void PendSV_Handler(void)
{
	fiber_portASM volatile(
			...
			/* FreeRTOS ARM_CM33_NTZ frame reused by ARM_TFM, low to high:
