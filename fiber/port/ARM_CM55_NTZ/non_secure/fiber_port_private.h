/* ARM_CM55_NTZ declarations shared only by its implementation objects. */
#ifndef FIBER_PORT_ARM_CM55_NTZ_FIBER_PORT_PRIVATE_H_
#define FIBER_PORT_ARM_CM55_NTZ_FIBER_PORT_PRIVATE_H_
...
#endif /* FIBER_PORT_ARM_CM55_NTZ_FIBER_PORT_PRIVATE_H_ */
