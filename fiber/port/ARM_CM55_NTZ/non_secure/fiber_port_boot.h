/* ARM_CM55_NTZ boot-record declarations used only by this exact port. */
#ifndef FIBER_PORT_ARM_CM55_NTZ_FIBER_PORT_BOOT_H_
#define FIBER_PORT_ARM_CM55_NTZ_FIBER_PORT_BOOT_H_
...
#endif /* FIBER_PORT_ARM_CM55_NTZ_FIBER_PORT_BOOT_H_ */
