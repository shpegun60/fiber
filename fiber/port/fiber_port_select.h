...
BT_STATIC_ASSERT((FIBER_PORT_BUILD_SELECTED == 0) || (FIBER_PORT_BUILD_SELECTED == 1),
...
BT_STATIC_ASSERT((FIBER_PORT_BUILD_SELECTED == 0) || (FIBER_PORT_PROFILE_IS_EXPLICIT == 0),
...
BT_STATIC_ASSERT((FIBER_PORT_SELECTION_ALLOW_MISMATCH == 0) || (FIBER_PORT_SELECTION_ALLOW_MISMATCH == 1),
...
BT_STATIC_ASSERT((FIBER_PORT_SELECTION_ALLOW_MISMATCH != 0) || FIBER_PORT_PROFILE_MATCHES_DETECTED,
...
BT_STATIC_ASSERT(((FIBER_PORT_BUILD_SELECTED == 0) && (FIBER_PORT_PRESET_COUNT == 0)) ||
...
BT_STATIC_ASSERT((FIBER_PORT_BUILD_SELECTED == 0) || (FIBER_PORT_FORCE_COUNT == 0),
...
BT_STATIC_ASSERT((FIBER_PORT_SELECTION_ALLOW_MISMATCH != 0) || FIBER_PORT_FORCE_MATCHES_DETECTED,
...
BT_STATIC_ASSERT((FIBER_PORT_SELECTION_ALLOW_MISMATCH != 0) ||
...
/*
 * Architecture feature gates consumed by the rest of the target layer.
 * These are selected from the port profile, not from STM32 family names.
 */
