...
/*
 * Internal result macros must be generated by this header.
 *
 * Do not let application builds predefine FIBER_PORT_ARMV*. A direct override
 * would bypass profile validation and make the selected port harder to audit.
...
BT_STATIC_ASSERT(FIBER_PORT_PRESET_COUNT == 0,
                 "[fiber]: do not predefine internal FIBER_PORT_* macros; use FIBER_PORT_PROFILE");
