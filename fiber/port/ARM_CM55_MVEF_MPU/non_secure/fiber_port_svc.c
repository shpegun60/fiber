/*
 * ARM_CM55_MVEF_MPU/non_secure strict first-start SVC component.
 *
 * The pinned FreeRTOS ARM_CM55_NTZ MPU+FPU+MVE branch restores its first task from
 ...
 * forward runtime ABI and pulls the separate MVE-FP PendSV component through
...
#define FIBER_CM55_MVEF_MPU_SVC \
	FIBER_API_ATTR_SENSITIVE FIBER_GENERAL_REGS_ONLY \
	fiber_portPRIVILEGED_FUNCTION

#define FIBER_CM55_MVEF_MPU_UNPRIVILEGED \
	FIBER_API_ATTR_SENSITIVE FIBER_GENERAL_REGS_ONLY \
...
static FIBER_CM55_MVEF_MPU_SVC
...
FIBER_CM55_MVEF_MPU_UNPRIVILEGED
...
FIBER_API_NORETURN FIBER_CM55_MVEF_MPU_SVC
		...
		uint32_t svc_exc_return FIBER_ATTR_UNUSED_PARAM)
{
	fiber_portASM volatile(
			...
			"ldmia r0!, {r4-r11}                                  \n"
			"stmia r2, {r4-r11}                                   \n"
#if FIBER_PORT_CM55_MVEF_MPU_TOTAL_REGIONS == 16
			"movs  r3, #8                                         \n"
			"str   r3, [r1]                                       \n"
			"ldmia r0!, {r4-r11}                                  \n"
			"stmia r2, {r4-r11}                                   \n"
