/* ARM_CM55_MVEF_MPU/non_secure protected construction and linker contract. */
#ifndef FIBER_PORT_ARM_CM55_MVEF_MPU_NON_SECURE_FIBER_PORT_BOOT_H_
#define FIBER_PORT_ARM_CM55_MVEF_MPU_NON_SECURE_FIBER_PORT_BOOT_H_
...
FIBER_STATIC_ASSERT(sizeof(FiberPortMpuMemoryLayout) == (12u * 4u),
		"[fiber]: ARM_CM55_MVEF_MPU linker-layout ABI changed");
FIBER_STATIC_ASSERT(sizeof(FiberPortMpuGlobalRegionImage) == (4u * 8u),
		"[fiber]: ARM_CM55_MVEF_MPU global MPU-image ABI changed");
...
/* MVE-FP CPU policy belongs to this selected port. The construction slice
 * exports the policy now; later SVC/PendSV slices consume the same three
...
#endif /* FIBER_PORT_ARM_CM55_MVEF_MPU_NON_SECURE_FIBER_PORT_BOOT_H_ */
