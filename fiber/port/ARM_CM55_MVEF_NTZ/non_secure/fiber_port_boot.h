/* ARM_CM55_MVEF_NTZ boot-record declarations used only by this exact port. */
#ifndef FIBER_PORT_ARM_CM55_MVEF_NTZ_FIBER_PORT_BOOT_H_
#define FIBER_PORT_ARM_CM55_MVEF_NTZ_FIBER_PORT_BOOT_H_
...
void fiber_port_boot_create(FiberPortBoot *boot,
		void *begin,
		void *end,
		entry_t entry,
		void *arg);
...
#endif /* FIBER_PORT_ARM_CM55_MVEF_NTZ_FIBER_PORT_BOOT_H_ */
