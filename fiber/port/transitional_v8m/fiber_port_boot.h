/* Transitional v8-M boot-record and first-start ABI. */
#ifndef FIBER_PORT_TRANSITIONAL_V8M_FIBER_PORT_BOOT_H_
#define FIBER_PORT_TRANSITIONAL_V8M_FIBER_PORT_BOOT_H_
...
#endif /* FIBER_PORT_TRANSITIONAL_V8M_FIBER_PORT_BOOT_H_ */
